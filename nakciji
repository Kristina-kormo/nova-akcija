...
<body translate="no"> <!-- запрет на автоматический перевод всей страницы -->
...
<div class="row">
  <div class="chain">
    ...
    <a href="https://docs.google.com/spreadsheets/d/YOUR_ROST_LINK/pubhtml?widget=true&headers=false"
       target="_blank" translate="no">Відкрити таблицю</a>
  </div>

  <div class="chain">
    <h2 translate="no">Аврора</h2>
    <a href="https://docs.google.com/spreadsheets/d/e/2PACX-1vQkMIEhtV2AgEVub5ZzPKDobfOnk_95BN0XKPIEkosbeY_ewPTx7oEtYj1ZIRLPBZe69Jggud61_TCZ/pubhtml"
       target="_blank" translate="no">Відкрити таблицю</a>
  </div>
